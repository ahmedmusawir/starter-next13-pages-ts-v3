...
const ProfileContent = () => {
  ...
  const selectedFile = watchImage("profileImage");
  const password = watchPassword("password");

  const onPasswordSubmit = (data: any, e: any) => {
    console.log("onPasswordSubmit called");
    e.preventDefault();
                      ...
                      <div className="w-full lg:w-9/12 px-4">
                        <div className="flex flex-wrap justify-center">
                          <div className="w-full lg:w-9/12 px-4">
                            ...
                            <form onSubmit={handleSubmitImage(onImageSubmit)}>
                              <input
                                type="file"
